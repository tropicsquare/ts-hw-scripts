...
if __name__ == "__main__":
    ...
    ts_info(TsInfoCode.INFO_GENERIC, "Number of parallel jobs: {ts_get_cfg('regress_jobs')}")
    ...
    if not ts_get_cfg("no_check"):
        ...
        # Check sim log files
        ts_info(TsInfoCode.INFO_GENERIC, "Checking log files:")
    ...
    ts_info(TsInfoCode.INFO_GENERIC, f"Copying regression logs to {reg_dir}")
