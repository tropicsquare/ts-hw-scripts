...
__ERR_CODE_MSG_PAIR = {
    TsErrCode.ERR_GENERIC: lambda string: str(string),
    ...
    TsErrCode.ERR_CMP_2: lambda file_name, exit_code: "Compilation failed on file '{}' with exit code {}. "
                                            "Check if has correct syntax! ".format(file_name, exit_code),
...
__WARN_CODE_MSG_PAIR = {
    # Generic warning
    TsWarnCode.WARN_GENERIC: lambda string: str(string),
...
__INFO_CODE_MSG_PAIR = {
    # Generic info code
    TsInfoCode.INFO_GENERIC: lambda string: str(string),
