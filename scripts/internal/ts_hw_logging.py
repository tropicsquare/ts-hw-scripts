...
####################################################################################################
# Dummy class for empty line print
####################################################################################################
class TsEmptyCode(Enum):
    """
    """
    EMPTY_INFO = auto()

__DUMMY_CODE_MSG_PAIR = {
    # Generic info code
    TsEmptyCode.EMPTY_INFO: lambda: ""
}
...
__INFO_CODE_MSG_PAIR = {
    ...
    TsInfoCode.INFO_CMN_12: lambda: "Tests available:",
    ...
    TsInfoCode.INFO_CMN_16: lambda: "Test results:",
    TsInfoCode.INFO_CMN_17: lambda: "List of errors:",
    TsInfoCode.INFO_CMN_18: lambda: "List of warnings:",
    TsInfoCode.INFO_CMN_19: lambda: "List of ignored errors:",
    TsInfoCode.INFO_CMN_20: lambda: "List of ignored warnings:",
...
def ts_process_log(code, *opt_args):
    ...
    # Dummy message just to print empty line
    elif isinstance(code, TsEmptyCode):
        func = logging.info
        func("")
        return
    else:
    ...
    try:
        ...
        ts_script_bug("Invalid number of arguments to info/warning/error code: {}".format(code))
...
def ts_throw_warning(warn_code: TsWarnCode, *opt_args):
    """
...
def ts_debug(msg):
    ...
    """
    logging.debug(CBLUE + "DEBUG: " + msg + CEND)
...
def ts_empty_line():
    """
    Print empty line into log
    """
    ts_process_log(TsEmptyCode.EMPTY_INFO);
