...
def __build_elab_command(test: dict, top_entity: str, log_file_path: str = "") -> (str, str):
    """
...
def __create_sim_command_file(sim_cmd_file: str):
    """
...
def __build_sim_command(test: dict, elab_dir: str, sim_dir: str, log_file_path: str, no_seed: bool = False) -> str:
    ...
    if not os.path.exists(sim_cmd_file):
        __create_sim_command_file(sim_cmd_file)
