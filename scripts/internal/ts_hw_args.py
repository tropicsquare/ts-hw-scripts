...
def add_pdk_cfg_args(parser):
    ...
    parser.add_argument("--add-map", action="store_true",
                       help="Export map file path needed usually for topological synthesis.")
...
def add_ts_syn_run_args(parser,tool_type):
    ...
    parser.add_argument("--report-postproc", action="store_true", default=False,
                       help="Run reports post-processing.")
