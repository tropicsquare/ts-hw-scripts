...
def add_cfg_files_arg(parser):
    ...
    parser.add_argument("-pc", "--pwr-cfg",
...
def add_pdk_cfg_args(parser):
    ...
    parser.add_argument("--add-spef", action="store_true",
                       help="Export of SPEF files paths per-mode needed usually for STA or PwR flows.")

    parser.add_argument("--add-map-tech", action="store_true",
                       help="Export map and tech files paths needed usually for topological synthesis.")

    parser.add_argument("--add-tluplus", action="store_true",
                       help="Exports Tlu+ files path and per modes rc_corners")

    parser.add_argument("--add-wireload", action="store_true",
                       help="Exports wireload library settings.")

    parser.add_argument("--add-opcond", action="store_true",
...
def add_ts_pwr_run_args(parser):
    ...
    parser.add_argument("scenario", nargs="*",
                        help="Scenarios on which power analysis is performed.")

    parser.add_argument("--clear-pwr", action="store_true", default=False,
                        help="Clear all directories of previous runs.")

    parser.add_argument("--clear-sim", action="store_true", default=False,
                        help="Passes --clear option to simulation script.")

    parser.add_argument("--clear-sim-logs", action="store_true", default=False,
                        help="Passes --clear-logs option to simulation script.")

    parser.add_argument("--recompile", action="store_true", default=False,
                        help="Passes --recompile option to simulation script.")

    parser.add_argument("--no-pwr-out", action="store_true", default=False,
    ...
    parser.add_argument("--gui", nargs="?", default=None,
                        help="Shows power waves in GUI. Only Verdi is supported.")

    parser.add_argument("--dump-pwr-waves", nargs="?", default=None,
                        choices=("fsdb", "out"),
                        help=dedent("""\
    ...
    parser.add_argument("--stay-in-pt-shell", action="store_true", default=False,
    ...
    parser.add_argument("--runcode", nargs="?", default=None,
                        help=dedent("""\
                            Mandatory.
    ...
    # TMP
    parser.add_argument("--vcd-dump", nargs="?", default=None,
...
def add_ts_mem_map_generator_args(parser):
    ...
    parser.add_argument("--latex-dir",
                        help="One or both arguments (--latex_dir, --xml_dir) required")
...
def add_ts_syn_run_args(parser,tool_type):
    ...
    :param parser: Argparse parser to which arguments shall be added
    """
    parser.add_argument("--no-floorplan", action="store_true", default=False,
    ...
    parser.add_argument("--break-after-link", action="store_true", default=False,
                       help=f"Stops {tool_type} after linking the design.")

    parser.add_argument("--break-after-constraints", action="store_true", default=False,
                       help=f"Stops {tool_type} after reading constraints file(s).")

    parser.add_argument("--break-after-compile", action="store_true", default=False,
                       help=f"Stops {tool_type} after first compilation.")

    parser.add_argument("--break-after-reports", action="store_true", default=False,
...
def add_ts_sta_run_args(parser,tool_type):
    ...
    parser.add_argument("--sign-off", action="store_true", default=False,
                       help=f"Run sign-off.")
    ...
    parser.add_argument("--dmsa", action="store_true", default=False,
                       help=f"Run DMSA. Mutually exclusive with --mode")

    parser.add_argument("--sdc-export", action="store_true", default=False,
...
def add_stayin_arg(parser,tool_type):
    ...
    :param tool_type: String name of a tool to be displayed in help
    """
    parser.add_argument("--stay-in-tool", action="store_true", default=False,
...
def add_source_data_arg(parser,default=None):
    ...
    :param parser: Argparse parser to which arguments shall be added
    """
    parser.add_argument("--source-data", nargs="?", default = default,
